...
class Bvb_Grid_Deploy_Table extends Bvb_Grid_DataGrid {
    ...
    */
	...
	function buildHeader() {
		...
		if ((@$this->info ['double_tables'] == 0 && @$this->ctrlParams ['add'] != 1 && @$this->ctrlParams ['edit'] != 1) && @$this->info ['user'] > 0 && $this->getPrimaryKey () && @$this->info ['add'] ['allow'] == 1 && @$this->info ['add'] ['button'] == 1 && @$this->info ['add'] ['no_button'] != 1) {
